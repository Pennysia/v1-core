...
contract MarketTest is Test {
    ...
    function test_SwapSingleHop() public {
        ...
        assertTrue(r0L + r0S < r0L_before + r0S_before, "Reserve0 should decrease (we're receiving token0)");
        assertTrue(r1L + r1S > r1L_before + r1S_before, "Reserve1 should increase (we're giving token1)");
    }
